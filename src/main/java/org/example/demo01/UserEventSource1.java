...
public class UserEventSource1 implements SourceFunction<UserEvent> {
...
//            UserEvent userEvent = new UserEvent(userId, "login",  loginTimestamp,  loginDate);
//            System.out.printf("userEvent"+userEvent);
//            ctx.collect(userEvent);
//            // 控制生成速度
//            Thread.sleep(3000); // 每 10ms 生成一个事件
//        }
    }
